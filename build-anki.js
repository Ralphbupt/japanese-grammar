...
async function main() {
  ...
  const cardCellsEn = summary
    ...
    <a class="anki-dl anki-dl-primary" rel="nofollow" href="jpnotes-${s.level}.apkg" onclick="trackDl('${s.level}','apkg','zh');return shareApkg(this, 'jpnotes-${s.level}.apkg')">⬇ <span class="lang-zh">.apkg 中文版（推荐 / 手机一键导入）</span><span class="lang-en">.apkg Chinese edition (one-tap import)</span></a>
    <a class="anki-dl anki-dl-primary anki-dl-en" rel="nofollow" href="jpnotes-${s.level}-en.apkg" onclick="trackDl('${s.level}','apkg','en');return shareApkg(this, 'jpnotes-${s.level}-en.apkg')">⬇ <span class="lang-zh">.apkg English 版（英文释义）</span><span class="lang-en">.apkg English edition (recommended)</span></a>
    ...
    <span class="anki-dl-alt-row"><a class="anki-dl anki-dl-alt" rel="nofollow" href="jpnotes-${s.level}.txt" download onclick="trackDl('${s.level}','tsv','zh')"><span class="lang-zh">.txt 中文</span><span class="lang-en">.txt Chinese</span></a> · <a class="anki-dl anki-dl-alt" rel="nofollow" href="jpnotes-${s.level}-en.txt" download onclick="trackDl('${s.level}','tsv','en')"><span class="lang-zh">.txt English</span><span class="lang-en">.txt English</span></a></span>
  </div>`
    )
    .join("\n");
