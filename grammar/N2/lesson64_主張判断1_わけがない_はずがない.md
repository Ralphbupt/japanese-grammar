...
| 嘘 | うそ | 谎话//lie |
| 本気 | ほんき | 认真//serious |
| 常識 | じょうしき | 常识//common sense |
| 裏切る | うらぎる | 背叛//to betray |
| 約束 | やくそく | 约定//promise |
| 破る | やぶる | 违反//to break |
| 優秀 | ゆうしゅう | 优秀//excellent |
| 不合格 | ふごうかく | 不合格//failure (exam) |
...
:::zh
1. 上司に頼まれたら、断ら**ないわけにはいかない**。（被上司拜托了，不能不答应。）
2. 明日は大事な会議だから、出席し**ないわけにはいかない**。（明天是重要会议，不能不出席。）
3. 約束した以上、守ら**ないわけにはいかない**。（既然约定了，就不能不遵守。）
4. お世話になった人だから、挨拶に行か**ないわけにはいかない**。（是照顾过我的人，不能不去打招呼。）
5. 社員として、会社のルールに従わ**ないわけにはいかない**。（作为员工，不能不遵守公司的规定。）
:::
:::en
1. 上司に頼まれたら、断ら**ないわけにはいかない**。(If my boss asks me, I can't refuse.)
2. 明日は大事な会議だから、出席し**ないわけにはいかない**。(Tomorrow's meeting is important, so I must attend.)
3. 約束した以上、守ら**ないわけにはいかない**。(Since I made a promise, I must keep it.)
4. お世話になった人だから、挨拶に行か**ないわけにはいかない**。(Since they've taken care of me, I must go pay my respects.)
5. 社員として、会社のルールに従わ**ないわけにはいかない**。(As an employee, I have no choice but to follow company rules.)
:::
...
### 例句||Example Sentences
:::zh
1. これだけの証拠があれば、彼が犯人である**に相違ない**。（有这么多证据，他一定是犯人。）
2. この結果は、日々の努力の成果である**に相違ない**。（这个结果一定是日常努力的成果。）
3. 彼女がこの計画に関わっている**に相違ない**。（她一定参与了这个计划。）
4. このまま放置すれば、問題は悪化する**に相違ない**。（如果就这样放置，问题一定会恶化。）
5. 彼の判断は正しかった**に相違ない**。（他的判断一定是正确的。）
:::
:::en
1. これだけの証拠があれば、彼が犯人である**に相違ない**。(With this much evidence, he is undoubtedly the criminal.)
2. この結果は、日々の努力の成果である**に相違ない**。(This result is undoubtedly the product of daily effort.)
3. 彼女がこの計画に関わっている**に相違ない**。(There is no doubt that she is involved in this plan.)
4. このまま放置すれば、問題は悪化する**に相違ない**。(If left as is, the problem will undoubtedly worsen.)
5. 彼の判断は正しかった**に相違ない**。(His judgment was undoubtedly correct.)
:::
...
### 例句||Example Sentences
:::zh
1. そんな簡単なことが分から**ないわけがない**。（那么简单的事，不可能不懂。）
2. あんなに優秀な彼が不合格な**わけがない**。（那么优秀的他，不可能不及格。）
3. 本気で努力した人が失敗する**わけがない**。（认真努力的人不可能会失败。）
4. 彼が裏切る**わけがない**。私は彼を信じている。（他不可能背叛。我相信他。）
5. たった一日で日本語が話せるようになる**わけがない**。（仅仅一天就能说日语，不可能。）
:::
:::en
1. そんな簡単なことが分から**ないわけがない**。(There's no way you can't understand something so simple.)
2. あんなに優秀な彼が不合格な**わけがない**。(There's no way someone as excellent as him would fail.)
3. 本気で努力した人が失敗する**わけがない**。(There's no way someone who truly tried hard would fail.)
4. 彼が裏切る**わけがない**。私は彼を信じている。(There's no way he would betray me. I trust him.)
5. たった一日で日本語が話せるようになる**わけがない**。(There's no way you can learn to speak Japanese in just one day.)
:::
...
### 例句||Example Sentences
:::zh
1. 彼は真面目な人だから、嘘をつく**はずがない**。（他是个认真的人，不可能说谎。）
2. 鍵をかけたはずだから、開いている**はずがない**。（我应该锁了门，不可能是开着的。）
3. まだ届いていない**はずがない**。先週送ったのだから。（不可能还没收到，上周就寄了。）
4. こんなに高い店で、まずい**はずがない**。（这么贵的店，不可能不好吃。）
5. 彼女が約束を忘れる**はずがない**。手帳に書いていたから。（她不可能忘了约定，因为写在手账上了。）
:::
:::en
1. 彼は真面目な人だから、嘘をつく**はずがない**。(He's a serious person, so there's no way he'd lie.)
2. 鍵をかけたはずだから、開いている**はずがない**。(I should have locked it, so it can't be open.)
3. まだ届いていない**はずがない**。先週送ったのだから。(It can't be that it hasn't arrived yet — I sent it last week.)
4. こんなに高い店で、まずい**はずがない**。(At a restaurant this expensive, the food can't be bad.)
5. 彼女が約束を忘れる**はずがない**。手帳に書いていたから。(She can't have forgotten the appointment — she wrote it in her planner.)
:::
...
1. 招待してくれた以上、行か（　　）。
2. 彼女は毎日練習しているから、下手な（　　）。
3. これだけの状況証拠から、彼が犯人である（　　）。
4. まだ届いていない（　　）。一週間前に出したのだから。
5. たった一日でピアノが弾けるようになる（　　）。

**二、「わけがない」还是「はずがない」？选择更合适的一个**

6. あの真面目な子が授業をサボる（　　）。
7. 人間が空を飛べる（　　）。
8. 鍵を忘れた（　　）。確かにポケットに入れたから。

**三、翻译成日语**

9. 被邀请了就不能不去。（ないわけにはいかない）
10. 这么努力的人不可能失败。（わけがない）
:::
:::en
