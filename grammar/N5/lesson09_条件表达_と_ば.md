# Lesson 09 – 条件表达 と・ば||Conditionals: と・ば

:::zh
这是N5-N4的**最大难点之一**。四种条件表达看起来都是"如果"，但用法完全不同。本课内容较多，安排两天学习。
:::
...
| 酒 | さけ | 酒//alcohol |
| 歌う | うたう | 唱歌//to sing |
| 始める | はじめる | 开始//to begin |
| 押す | おす | 按/推//to push |
| 曲がる | まがる | 转弯//to turn |
| 駅 | えき | 车站//station |
| 見える | みえる | 看得见//to be visible |
| 合格 | ごうかく | 及格//to pass |
| 免許 | めんきょ | 执照//license |
| 試合 | しあい | 比赛//match |
| 中止 | ちゅうし | 中止//cancellation |
| 電気 | でんき | 电灯//light |
| つく | つく | 亮（灯）；到达//to turn on |
| 塵 | ちり | 灰尘//dust |
| 積もる | つもる | 积累//to pile up |
| 届く | とどく | 送达//to reach |
| 沸く | わく | 沸腾//to boil |
| 慣れる | なれる | 习惯//to get used to |
| 相談する | そうだんする | 商量//to consult |
| 卒業 | そつぎょう | 毕业//graduation |
| 信号 | しんごう | 红绿灯//traffic light |
| 宝くじ | たからくじ | 彩票//lottery |
| 当たる | あたる | 中（奖）//to win |
| 迷う | まよう | 迷路；犹豫//to get lost |
...
:::zh
1. 春に**なると**、桜が咲く。（一到春天，樱花就开。）
2. 冬に**なると**、雪が降る。（一到冬天就下雪。）
3. 氷は温度が高く**なると**、溶ける。（冰温度一高就融化。）
4. 秋に**なると**、葉が赤くなる。（一到秋天，树叶就变红。）
5. 水は100度に**なると**、沸く。（水到100度就沸腾。）
:::

:::en
1. 春に**なると**、桜が咲く。（When spring arrives, the cherry blossoms bloom.）
2. 冬に**なると**、雪が降る。（When winter comes, it snows.）
3. 氷は温度が高く**なると**、溶ける。（When ice gets warm enough, it melts.）
4. 秋に**なると**、葉が赤くなる。（When autumn comes, the leaves turn red.）
5. 水は100度に**なると**、沸く。（When water reaches 100°C, it boils.）
:::

#### ② 習慣的動作||② Habitual actions

:::zh
1. 家に帰る**と**、すぐシャワーを浴びる。（一回家就马上洗澡。）
2. 彼は酒を飲む**と**、歌い始める。（他一喝酒就开始唱歌。）
3. 朝起きる**と**、まずコーヒーを飲む。（早上一起来就先喝咖啡。）
4. 母は疲れる**と**、甘いものを食べる。（妈妈一累就吃甜食。）
5. この道をまっすぐ行く**と**、公園に出る。（沿这条路直走就到公园。）
:::

:::en
1. 家に帰る**と**、すぐシャワーを浴びる。（As soon as I get home, I take a shower.）
2. 彼は酒を飲む**と**、歌い始める。（Once he drinks, he starts singing.）
3. 朝起きる**と**、まずコーヒーを飲む。（When I wake up in the morning, I first have coffee.）
4. 母は疲れる**と**、甘いものを食べる。（When my mother gets tired, she eats something sweet.）
5. この道をまっすぐ行く**と**、公園に出る。（If you go straight down this road, you reach the park.）
:::

#### ③ 操作/指示||③ Operations / instructions

:::zh
1. このボタンを押す**と**、ドアが開きます。（按这个按钮，门就会开。）
2. 右に曲がる**と**、駅が見えます。（右转就能看到车站。）
3. ここをクリックする**と**、ページが変わります。（点击这里，页面就会变。）
4. カードを入れる**と**、お金が出ます。（插入卡，钱就出来。）
5. このスイッチを押す**と**、電気がつきます。（按这个开关，灯就亮。）
:::

:::en
1. このボタンを押す**と**、ドアが開きます。（If you press this button, the door opens.）
2. 右に曲がる**と**、駅が見えます。（If you turn right, you'll see the station.）
3. ここをクリックする**と**、ページが変わります。（If you click here, the page changes.）
4. カードを入れる**と**、お金が出ます。（If you insert the card, the money comes out.）
5. このスイッチを押す**と**、電気がつきます。（If you flip this switch, the light turns on.）
:::

#### ④ 発見（過去時）||④ Discovery (past tense)

:::zh
1. 窓を開ける**と**、富士山が見えた。（一开窗，看到了富士山。）
2. ドアを開ける**と**、猫がいた。（一开门，发现有只猫。）
3. 箱を開ける**と**、手紙が入っていた。（一打开箱子，里面有封信。）
4. 電話する**と**、もう出かけた後だった。（一打电话，人已经出门了。）
:::

:::en
1. 窓を開ける**と**、富士山が見えた。（When I opened the window, I could see Mt. Fuji.）
2. ドアを開ける**と**、猫がいた。（When I opened the door, there was a cat.）
3. 箱を開ける**と**、手紙が入っていた。（When I opened the box, there was a letter inside.）
4. 電話する**と**、もう出かけた後だった。（When I called, they had already gone out.）
:::
...
| 词类 | 规则 | 例子 |
|------|------|------|
| 一类动词 | う段→え段+ば | 行く→行**けば**、飲む→飲**めば** |
| 二类动词 | る→**れば** | 食べる→食べ**れば**、見る→見**れば** |
| する | す**れば** | すれば |
| 来る | 来（く）**れば** | 来れば（くれば） |
| い形容词 | い→**ければ** | 高い→高**ければ**、いい→**よければ** |
| な形容词 | 〜**であれば** / 〜**なら** | 静かであれば |
| 名词 | 〜**であれば** / 〜**なら** | 学生であれば |
:::
...
|------|------|------|
| Group 1 verb | う-row → え-row + ば | 行く→行**けば**, 飲む→飲**めば** |
| Group 2 verb | る → **れば** | 食べる→食べ**れば**, 見る→見**れば** |
| する | す**れば** | すれば |
| 来る | 来（く）**れば** | 来れば（くれば） |
| い-adjective | い → **ければ** | 高い→高**ければ**, いい→**よければ** |
| な-adjective | 〜**であれば** / 〜**なら** | 静かであれば |
| Noun | 〜**であれば** / 〜**なら** | 学生であれば |
:::

### 一类动詞假定形：う段→え段||Group 1 verb conditional: う-row → え-row
...
:::zh
1. 天気がよ**ければ**、出かけましょう。（天气好的话，出去吧。）
2. 安**ければ**、買いたい。（便宜的话想买。）
3. もっと勉強す**れば**、合格できる。（更努力学习的话就能考过。）
4. 時間が**あれば**、遊びに行きたい。（有时间的话想去玩。）
5. よ**ければ**、一緒に食べませんか。（可以的话，一起吃吗？）
6. 薬を飲**めば**、すぐよくなりますよ。（吃药的话马上就会好的。）
7. 日本に住**めば**、日本語が上手になる。（住在日本的话，日语会变好。）
:::

:::en
1. 天気がよ**ければ**、出かけましょう。（If the weather is nice, let's go out.）
2. 安**ければ**、買いたい。（If it's cheap, I want to buy it.）
3. もっと勉強す**れば**、合格できる。（If you study harder, you'll be able to pass.）
4. 時間が**あれば**、遊びに行きたい。（If I have time, I'd like to go hang out.）
5. よ**ければ**、一緒に食べませんか。（If that's alright with you, shall we eat together?）
6. 薬を飲**めば**、すぐよくなりますよ。（If you take the medicine, you'll get better quickly.）
7. 日本に住**めば**、日本語が上手になる。（If you live in Japan, your Japanese will improve.）
:::

### ばの特点||Characteristics of ば

:::zh
- 适合表达**一般条件/道理**
- 常用于谚语：塵も積も**れば**山となる（积少成多）
- 后半句可以接意志（和と不同）
...
- Common in proverbs: 塵も積も**れば**山となる（Many a little makes a mickle.）
...
:::zh
1. 大学を卒業し**たら**、日本に行きたい。（大学毕业后想去日本。）
2. 仕事が終わっ**たら**、電話してください。（工作结束后请打电话。）
3. 18歳になっ**たら**、車の免許が取れる。（到18岁就能考驾照。）
4. 届い**たら**、すぐ連絡してください。（东西到了的话请马上联系。）
5. お金が貯まっ**たら**、旅行に行く。（攒够钱之后去旅行。）
:::

:::en
1. 大学を卒業し**たら**、日本に行きたい。（After graduating from university, I want to go to Japan.）
2. 仕事が終わっ**たら**、電話してください。（Please call me when you finish work.）
3. 18歳になっ**たら**、車の免許が取れる。（Once you turn 18, you can get a driver's licence.）
4. 届い**たら**、すぐ連絡してください。（When it arrives, please contact me right away.）
5. お金が貯まっ**たら**、旅行に行く。（Once I've saved up money, I'll go travelling.）
:::

#### ② 假設（万一）||② Hypothesis (what if)

:::zh
1. 雨が降っ**たら**、試合は中止です。（万一下雨，比赛取消。）
2. もし100万円あっ**たら**、何をしますか。（如果有100万日元，你会做什么？）
3. もし暇だっ**たら**、手伝ってください。（如果有空的话请帮忙。）
4. 宝くじが当たっ**たら**、家を買いたい。（中了彩票的话想买房。）
5. 分からなかっ**たら**、先生に聞いてください。（不明白的话请问老师。）
6. 道に迷っ**たら**、この番号に電話してください。（迷路的话请打这个号码。）
:::

:::en
1. 雨が降っ**たら**、試合は中止です。（If it rains, the match will be cancelled.）
2. もし100万円あっ**たら**、何をしますか。（If you had 1 million yen, what would you do?）
3. もし暇だっ**たら**、手伝ってください。（If you're free, please help me.）
4. 宝くじが当たっ**たら**、家を買いたい。（If I won the lottery, I'd want to buy a house.）
5. 分からなかっ**たら**、先生に聞いてください。（If you don't understand, please ask the teacher.）
6. 道に迷っ**たら**、この番号に電話してください。（If you get lost, please call this number.）
:::

#### ③ 意外発見（過去時）||③ Unexpected discovery (past tense)

:::zh
1. 家に帰っ**たら**、誰もいなかった。（回到家发现谁都不在。）
2. 薬を飲ん**だら**、すぐ元気になった。（吃了药马上就好了。）
3. 窓を開け**たら**、雨が降っていた。（一开窗发现在下雨。）
4. 日本に来**たら**、すぐ日本語に慣れた。（来了日本之后很快就习惯日语了。）
5. よく見**たら**、友達だった。（仔细一看，原来是朋友。）
:::

:::en
1. 家に帰っ**たら**、誰もいなかった。（When I got home, nobody was there.）
2. 薬を飲ん**だら**、すぐ元気になった。（After taking the medicine, I got better right away.）
3. 窓を開け**たら**、雨が降っていた。（When I opened the window, it was raining.）
4. 日本に来**たら**、すぐ日本語に慣れた。（After coming to Japan, I quickly got used to Japanese.）
5. よく見**たら**、友達だった。（When I looked closely, it turned out to be a friend.）
:::

### たらの超能力||The superpower of たら
