# Lesson 10 – 条件表达 たら・なら||Conditionals: たら・なら
...
### 典型対話場景||Typical dialogue scenarios

:::zh
**场景一：推荐餐厅**
- A：日本料理が食べたいんですが…（想吃日本料理……）
- B：日本料理**なら**、あの店がいいですよ。（日本料理的话，那家店不错。）

**场景二：推荐季节**
- A：北海道に行きたいんですが…（想去北海道……）
- B：北海道**なら**、冬がおすすめです。（北海道的话，推荐冬天去。）

**场景三：给出提醒**
- A：明日、面接があるんです。（明天有面试。）
- B：面接**なら**、スーツを着たほうがいいですよ。（面试的话，穿西装比较好。）

**场景四：给出信息**
- A：田中さんはどこですか。（田中在哪里？）
- B：田中さん**なら**、さっき帰りましたよ。（田中的话，刚才回去了。）
:::

:::en
**Scenario 1: Recommending a restaurant**
- A：日本料理が食べたいんですが…（I'd like to eat Japanese food…）
- B：日本料理**なら**、あの店がいいですよ。（For Japanese food, that restaurant is great.）

**Scenario 2: Recommending a season**
- A：北海道に行きたいんですが…（I'd like to go to Hokkaido…）
- B：北海道**なら**、冬がおすすめです。（For Hokkaido, winter is recommended.）

**Scenario 3: Offering a reminder**
- A：明日、面接があるんです。（I have an interview tomorrow.）
- B：面接**なら**、スーツを着たほうがいいですよ。（For an interview, you'd better wear a suit.）

**Scenario 4: Giving information**
- A：田中さんはどこですか。（Where is Tanaka?）
- B：田中さん**なら**、さっき帰りましたよ。（Tanaka? He just went home a moment ago.）
:::

### 例句||Example sentences

:::zh
1. 安いの**なら**、買います。（便宜的话就买。）
2. 暇**なら**、手伝ってくれない？（有空的话能帮我吗？）
3. パソコン**なら**、秋葉原で買ったほうがいい。（电脑的话，在秋叶原买比较好。）
4. 行く**なら**、早く行ったほうがいい。（要去的话，早点去比较好。）
5. 彼が来ない**なら**、私も行かない。（他不来的话，我也不去。）
6. 相談する**なら**、山田さんがいいですよ。（商量的话，找山田比较好。）
7. 日本語を勉強する**なら**、日本に住んだほうがいい。（学日语的话，住在日本比较好。）
:::

:::en
1. 安いの**なら**、買います。（If it's a cheap one, I'll buy it.）
2. 暇**なら**、手伝ってくれない？（If you're free, could you help me?）
3. パソコン**なら**、秋葉原で買ったほうがいい。（For a computer, it's better to buy in Akihabara.）
4. 行く**なら**、早く行ったほうがいい。（If you're going, you'd better go early.）
5. 彼が来ない**なら**、私も行かない。（If he's not coming, I won't go either.）
6. 相談する**なら**、山田さんがいいですよ。（If you want to consult someone, Yamada is a good choice.）
7. 日本語を勉強する**なら**、日本に住んだほうがいい。（If you're studying Japanese, it's better to live in Japan.）
:::

### なら的特点||Characteristics of なら
...
### 同一個文の四種說法||The same sentence in all four forms

:::zh
**"如果下雨就不去了"：**
- ❌ 雨が降る**と**、行かない。（と后面不能接意志 → 不自然）
- ✅ 雨が降**れば**、行かない。（如果下雨的话就不去。）
- ✅ 雨が降っ**たら**、行かない。（万一下雨就不去。→ 最自然）
- ✅ 雨**なら**、行かない。（下雨的话就不去。→ 简洁）

**"到了车站请打电话"：**
- ❌ 駅に着く**と**、電話してください。（と不能接请求）
- △ 駅に着**けば**、電話してください。（ば+同主语意志动作，生硬）
- ✅ 駅に着い**たら**、電話してください。（到了车站后请打电话 → 最自然）
- ✅ 駅に着く**なら**、電話してください。（要到车站的话请打电话 → 语感稍不同）
:::

:::en
**"If it rains, I won't go":**
- ❌ 雨が降る**と**、行かない。（と cannot be followed by volition → unnatural）
- ✅ 雨が降**れば**、行かない。（If it rains, I won't go.）
- ✅ 雨が降っ**たら**、行かない。（If it should rain, I won't go. → most natural）
- ✅ 雨**なら**、行かない。（If it's raining, I won't go. → concise）

**"When you reach the station, please call":**
- ❌ 駅に着く**と**、電話してください。（と cannot be followed by a request）
- △ 駅に着**けば**、電話してください。（ば + same-subject volitional → stiff）
- ✅ 駅に着い**たら**、電話してください。（Please call once you've reached the station. → most natural）
- ✅ 駅に着く**なら**、電話してください。（If you're going to the station, please call. → slightly different nuance）
:::

### 選択口訣||Quick decision guide
...
:::en
> ❌ 雨が降る**と**、傘を持っていってください。
> ✅ 雨が降っ**たら**、傘を持っていってください。（If it rains, please take an umbrella.）

**Reason**: と expresses a natural/inevitable result, so it cannot be followed by volitional behaviour (requests, commands, advice).
:::

### 错误2：ば用于同主语意志动作||Mistake 2: using ば with same-subject volitional actions

:::zh
> ❌ 東京に行**けば**、スカイツリーを見てください。
> ✅ 東京に行っ**たら**、スカイツリーを見てください。（去东京的话请看晴空塔。）
...
:::en
> ❌ 東京に行**けば**、スカイツリーを見てください。
> ✅ 東京に行っ**たら**、スカイツリーを見てください。（If you go to Tokyo, please see the Skytree.）
...
### 错误3：自然规律用たら||Mistake 3: using たら for a natural law

:::zh
> △ 春になっ**たら**、桜が咲く。（语法上不算错，但不地道）
> ✅ 春に**なると**、桜が咲く。（一到春天樱花就开。）

**原因**：自然规律/反复性事实用と最地道。たら虽然万能，但在"每次必然"的语境下不如と自然。
:::

:::en
> △ 春になっ**たら**、桜が咲く。（not technically wrong, but unidiomatic）
> ✅ 春に**なると**、桜が咲く。（When spring comes, the cherry blossoms bloom.）
...
### 错误4：なら用于时间先后||Mistake 4: using なら to express time sequence

:::zh
> ❌ 家に帰る**なら**、シャワーを浴びる。（想表达"回家后洗澡"）
> ✅ 家に帰っ**たら**、シャワーを浴びる。（回家后洗澡。）

**原因**：なら不强调时间顺序，用于"如果提到…的话"的话题条件。表达"做完A之后做B"要用たら。
:::

:::en
> ❌ 家に帰る**なら**、シャワーを浴びる。（intending "after I get home I'll shower"）
> ✅ 家に帰っ**たら**、シャワーを浴びる。（After I get home, I'll shower.）

**Reason**: なら does not express time order — it is for topic-based conditions ("speaking of …"). To express "after doing A, do B", use たら.
:::

### 错误5：过去的意外发现用ば||Mistake 5: using ば for a past unexpected discovery

:::zh
> ❌ ドアを開**ければ**、猫がいた。
> ✅ ドアを開ける**と**、猫がいた。（一开门发现有只猫。）
> ✅ ドアを開け**たら**、猫がいた。（开了门发现有只猫。）
...
:::en
> ❌ ドアを開**ければ**、猫がいた。
> ✅ ドアを開ける**と**、猫がいた。（When I opened the door, there was a cat.）
> ✅ ドアを開け**たら**、猫がいた。（When I opened the door, I found a cat.）

**Reason**: ば cannot be used for past events that already happened. Use と or たら for past discoveries.
:::

### 错误6：混淆なら和たら的时间关系||Mistake 6: confusing the time relationship of なら and たら

:::zh
> 東京に行く**なら**、お土産を買ってきてね。（你要去东京的话，给我带特产。→ 拜托在出发前）
> 東京に行っ**たら**、お土産を買ってきてね。（到了东京后，给我带特产。→ 到了之后再买）

**注意**：两句都对，但意思微妙不同。なら的建议/请求可以先于条件发生。
:::

:::en
> 東京に行く**なら**、お土産を買ってきてね。（If you're going to Tokyo, bring me back a souvenir. → request made before departure）
> 東京に行っ**たら**、お土産を買ってきてね。（Once you're in Tokyo, buy me a souvenir. → to be done after arrival）
...
1. 春に（　　）、花が咲きます。（自然规律）
2. 明日雨が（　　）、試合は中止です。（万一）
3. 日本料理（　　）、この店がおすすめです。（建议）
4. このボタンを（　　）、ドアが開きます。（操作）
5. もっと練習（　　）、上手になれる。（假设条件）
6. 仕事が（　　）、電話してください。（完成后请求）
7. 水は0度に（　　）、氷になる。（自然规律）
8. パスポートを（　　）、海外旅行ができる。（一般条件/道理）
:::

:::en
1. 春に（　　）、花が咲きます。（natural law）
2. 明日雨が（　　）、試合は中止です。（what if）
3. 日本料理（　　）、この店がおすすめです。（recommendation）
4. このボタンを（　　）、ドアが開きます。（operation）
5. もっと練習（　　）、上手になれる。（hypothetical condition）
6. 仕事が（　　）、電話してください。（request after completion）
7. 水は0度に（　　）、氷になる。（natural law）
8. パスポートを（　　）、海外旅行ができる。（general condition / principle）
:::
...
3. **なら**（接话题给建议）
4. 押す**と**（操作=必然结果）
5. す**れば** / し**たら**（假设条件，两个都可以）
6. 終わっ**たら**（完成后+请求，必须用たら）
7. なる**と**（自然规律用と）
8. 持ってい**れば** / 持っていっ**たら**（一般条件，ば或たら都可以）
:::

:::en
1. なる**と** (natural law → use と)
2. 降っ**たら** (what if + judgment follows)
3. **なら** (picking up topic to give advice)
4. 押す**と** (operation = inevitable result)
5. す**れば** / し**たら** (hypothetical, both work)
6. 終わっ**たら** (after completion + request → must use たら)
7. なる**と** (natural law → use と)
8. 持ってい**れば** / 持っていっ**たら** (general condition, ば or たら both fine)
:::

</details>

### B. 翻译成日语||B. Translate into Japanese
...
:::en
1. If you press this button, the light will turn on.
2. If it's cheap, I'll buy it.
3. If you have time, please come and hang out.
4. For sushi, this restaurant is the best.
5. Once you turn 20, you can drink alcohol.
6. If you're studying Japanese, this book is great.
:::
...
:::zh
1. このボタンを押すと、電気がつきます。（操作→必然，用と）
2. 安ければ / 安かったら、買います。（一般条件ば或万能たら）
3. 時間があったら、遊びに来てください。（请求，用たら）
4. 寿司なら、この店が一番美味しいです。（话题建议，用なら）
5. 20歳になったら、お酒が飲める。（确定的将来，用たら）
6. 日本語を勉強するなら、この本がいいですよ。（话题建议，用なら）
:::

:::en
1. このボタンを押すと、電気がつきます。（operation → inevitable → use と）
2. 安ければ / 安かったら、買います。（general condition ば or versatile たら）
3. 時間があったら、遊びに来てください。（request → use たら）
4. 寿司なら、この店が一番美味しいです。（topic + advice → use なら）
5. 20歳になったら、お酒が飲める。（definite future → use たら）
6. 日本語を勉強するなら、この本がいいですよ。（topic + advice → use なら）
:::
...
:::zh
1. 雨が降ると、傘を持っていってください。
2. 東京に行けば、スカイツリーに登ってください。
3. 春になったら、桜が咲きます。（想表达"每年都会"）
4. ドアを開ければ、猫がいた。
5. 家に帰るなら、すぐ宿題をする。（想表达"每天回家就写作业"的习惯）
:::

:::en
1. 雨が降ると、傘を持っていってください。
2. 東京に行けば、スカイツリーに登ってください。
3. 春になったら、桜が咲きます。（intending "it happens every year"）
4. ドアを開ければ、猫がいた。
5. 家に帰るなら、すぐ宿題をする。（intending "every day when I get home I do homework"）
:::
...
:::zh
1. ❌ と后面不能接请求 → 雨が降っ**たら**、傘を持っていってください。
2. ❌ ば+同主语意志动作不自然 → 東京に行っ**たら**、スカイツリーに登ってください。
3. △ 自然规律/习惯用と更地道 → 春に**なると**、桜が咲きます。
4. ❌ ば不能用于过去事实 → ドアを開ける**と** / 開け**たら**、猫がいた。
5. ❌ なら不表达习惯 → 家に帰る**と**、すぐ宿題をする。
:::

:::en
1. ❌ と cannot be followed by a request → 雨が降っ**たら**、傘を持っていってください。
2. ❌ ば + same-subject volitional is unnatural → 東京に行っ**たら**、スカイツリーに登ってください。
3. △ と is more idiomatic for natural laws / habits → 春に**なると**、桜が咲きます。
4. ❌ ば cannot be used for past facts → ドアを開ける**と** / 開け**たら**、猫がいた。
5. ❌ なら does not express habit → 家に帰る**と**、すぐ宿題をする。
:::
...
:::zh
1. 天気がいい**と**、公園に行く。 → △（と后面接意志行为，不太合适。但如果理解为"每次天气好都去"的习惯，则可以）
2. 天気がよ**ければ**、公園に行く。 → ✅（前半是状态，自然）
3. 天気がよかっ**たら**、公園に行く。 → ✅（万能たら，最日常）
4. 天気がいい**なら**、公園に行こう。 → ✅（话题：既然天气好的话，去公园吧）
:::

:::en
1. 天気がいい**と**、公園に行く。 → △ (と followed by a volitional action is not ideal; acceptable if read as a habit "every time the weather is nice I go")
2. 天気がよ**ければ**、公園に行く。 → ✅ (first clause is stative, sounds natural)
3. 天気がよかっ**たら**、公園に行く。 → ✅ (versatile たら, most everyday)
4. 天気がいい**なら**、公園に行こう。 → ✅ (topic-based: since the weather is good, let's go to the park)
:::
