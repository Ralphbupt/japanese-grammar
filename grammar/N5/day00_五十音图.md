...
## 浊音・半浊音||Dakuon & Handakuon — Voiced & Semi-voiced Sounds
...
## 特殊发音规则||Special Pronunciation Rules
...
- おかあさん（お**かあ**さん → extended "a" sound）
- おにいさん（お**にい**さん → extended "i" sound）
...
## 五十音图与动词变形的关系||The Syllabary and Verb Conjugation
...
### 动词变形 = 在同一行里移动||Verb Conjugation = Moving Within the Same Row
...
:::
:::en
| Conjugation | Shift to column | Result |
|------|----------|------|
| Polite (ます) | い | 書**き**ます |
| Negative (ない) | あ | 書**か**ない |
| Potential | え | 書**け**る |
| Volitional | お | 書**こ**う |
| Conditional | え | 書**け**ば |
:::
...
| 变到哪段 | 用途 | 書く | 飲む | 話す | 帰る |
|---------|------|------|------|------|------|
| あ段 | ない形 | 書**か** | 飲**ま** | 話**さ** | 帰**ら** |
| い段 | ます形 | 書**き** | 飲**み** | 話**し** | 帰**り** |
| う段 | 辞书形 | 書**く** | 飲**む** | 話**す** | 帰**る** |
| え段 | 可能形/假定形 | 書**け** | 飲**め** | 話**せ** | 帰**れ** |
| お段 | 意向形 | 書**こ** | 飲**も** | 話**そ** | 帰**ろ** |

> **这就是为什么一类动词叫"五段动词"** — 因为它在五十音图的五个段之间跳来跳去！
:::
:::en
| Column | Use | 書く | 飲む | 話す | 帰る |
|---------|------|------|------|------|------|
| あ | Negative (ない) | 書**か** | 飲**ま** | 話**さ** | 帰**ら** |
| い | Polite (ます) | 書**き** | 飲**み** | 話**し** | 帰**り** |
| う | Dictionary form | 書**く** | 飲**む** | 話**す** | 帰**る** |
| え | Potential / Conditional | 書**け** | 飲**め** | 話**せ** | 帰**れ** |
| お | Volitional | 書**こ** | 飲**も** | 話**そ** | 帰**ろ** |
