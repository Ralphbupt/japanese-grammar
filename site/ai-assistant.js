...
(function () {
  ...
  var PROVIDERS = {
    ...
    openrouter: { keyUrl: 'https://openrouter.ai/settings/keys', freeZh: '一个 key 用所有模型，:free 模型每天 50 次免费', freeEn: 'One key for every model; :free models give 50 free requests a day', group: 'relay', name: 'OpenRouter (聚合)', kind: 'openai', needsKey: true,
      ...
      hintZh: '一个 key 用所有模型，在 openrouter.ai 创建；明确支持浏览器直连。模型名以 :free 结尾的免费（每天 50 次，充过 $10 后 1000 次），点 ⟳ 查看。', hintEn: 'One key for every model; create it at openrouter.ai. Browser calls are officially supported. Models ending in :free cost nothing (50 requests/day, 1000 once you have bought $10 of credit); click ⟳ to list them.' },
